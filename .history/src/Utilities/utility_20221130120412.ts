...
export const NavElements = 
    ...
    export const QuoteTexts = [
      {quote_title: QUOTE_TITLE_ONE,quote_content: QUOTE_CONTENT_ONE.en},
      {quote_title: QUOTE_TITLE_TWO,quote_content: QUOTE_CONTENT_TWO.en},
      {quote_title: QUOTE_TITLE_THREE,quote_content: QUOTE_CONTENT_THREE.en}
    ]
