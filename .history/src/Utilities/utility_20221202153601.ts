...
import { AUTHOR_THREE } from '../../.history/src/constants/dictionary_20221201175340';
import { 
  QUOTES_LABEL, 
  TRANSLATE_LABEL,
  SEARCH_LABEL,
...
export const NavElements = 
    ...
    export const AuthorsList = [
      {value:AUTHOR_ONE, label:AUTHOR_ONE},
      {value: AUTHOR_TWO, label:AUTHOR_TWO},
      {value: AUTHOR_THREE, label: AUTHOR_THREE}
    ]
